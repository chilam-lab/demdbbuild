...
INPUT_RASTER = INPUT_DIR / "wc2.1_30s_elev.tif"
AOI_SHAPEFILE = DATA_DIR / "aoi_extent.shp"
# Archivos de salida intermedios/finales del pipeline.
CLIPPED_RASTER = RASTER_OUTPUT_DIR / "wc2.1_30s_elev_americas.tif"
DISCRETE_RASTER = RASTER_OUTPUT_DIR / "wc2.1_30s_elev_americas_bins.tif"
DISCRETE_SHP = SHAPE_OUTPUT_DIR / "wc2.1_30s_elev_americas_bins.shp"

# Metadatos que se guardan en catálogo de la DB.
SOURCE_CODE = "worldclim_dem_30s"
